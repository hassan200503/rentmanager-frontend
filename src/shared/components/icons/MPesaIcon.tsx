...
/**
 * Official M-PESA SVG wordmark.
 * Path data sourced from the M-PESA_LOGO-01.svg published on Wikimedia Commons
 * (public domain — does not meet originality threshold for copyright).
 * Trademark notice: "M-PESA" is a Safaricom/Vodafone trademark.
 *
 * Colors (verbatim from the official SVG):
 *   #39b54a — green wordmark text
 *   #d8e3d2 — light rectangle (mobile device icon body)
 *   #9d4c44 — dark red inner swoosh
 *   #ed1c24 — bright red outer swoosh
 */
export function MPesaIcon(props: IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      {/* Green wordmark — "MPESA" letterforms */}
      <path
        ...
        strokeWidth="2"
      />
      {/* Light rectangle — mobile device icon body */}
      <path
        d="m172 80.6v9.36c-15.2 0.0524-30.2 0.0158-45.3 0.0158-12.9 0-14.4 6.09-14.4 15.7v131c0 7.81 6.44 14.1 14.4 14.1h43.1c7.99 0 14.4-6.29 14.4-14.1v-157c0-1.97-1.59-5.95-5.39-5.77-4.27 0.237-6.78 3.37-6.91 5.77zm-37.1 27.1h27.6c11.6 0 13.2 7.25 13.2 15.1v46.7c0 5.8-5.03 14.9-13.2 14.9h-27.6c-9.97 0-15.2-8.6-15.2-14.9v-46.7c0-7.81 4.13-15.1 15.2-15.1z"
        fill="#d8e3d2"
        fillRule="evenodd"
        strokeWidth=".998"
      />
      {/* Dark red inner swoosh */}
      <path
        d="m104 155c9.07-0.942 17.2-5.6 26.4-17.6 10.4 15.8 24.7 15.2 39.2 16.8-15.6 0.163-13.6 5.52-34.8 4.03-6.77-0.473-17.9-0.936-30.7-3.19z"
        fill="#9d4c44"
        fillRule="evenodd"
        strokeWidth=".998"
      />
      {/* Bright red outer swoosh */}
      <path
        d="m161 122 33.8 16.4c-24.1 26.9-58.5 25.1-90.2 16.8 17.5-0.0728 33 6.4 56.3-33.1z"
        fill="#ed1c24"
        fillRule="evenodd"
        strokeWidth=".998"
      />
