...
import { Search, CheckCircle2, ShieldCheck, FileText, LogIn } from "lucide-react";
  ...
  return (
    <PremiumVideoHero eyebrow={eyebrow}>
      ...
      >
        ...
        {/* Sign in — one door for everyone; the account decides where it goes. */}
        <div className="mt-6 flex flex-wrap items-center justify-center gap-x-2.5 gap-y-2 text-xs text-white/50">
          ...
          >
            <LogIn className="h-3.5 w-3.5 text-jade-300 transition-colors duration-300 group-hover:text-jade-200" strokeWidth={1.75} aria-hidden="true" />
            Sign in
          </a>
        </div>
