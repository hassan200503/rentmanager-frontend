...
const DASHBOARD_STATS = [
  { label: "Portfolio Health", value: "94%", bar: "w-[94%]", tone: "text-emerald-300 bg-emerald-500/10 border-emerald-500/20" },
  ...
  return (
    <section className="relative py-24 md:py-32 overflow-hidden">
      <div className="absolute inset-0" aria-hidden="true">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[900px] h-[500px] bg-emerald-500/[0.06] rounded-full blur-[140px]" />
      </div>
        ...
        <div ref={ref} className={`transition-all duration-1000 ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          <div className="laptop-mockup relative">
            <div className="relative mx-auto max-w-4xl">
              <div className="absolute inset-0 bg-gradient-to-b from-emerald-500/10 to-transparent rounded-3xl blur-3xl" aria-hidden="true" />

              <div className="screen relative glass rounded-2xl overflow-hidden border border-white/10 shadow-2xl shadow-black/50">
                {/* Window chrome */}
                ...
                <div className="px-5 pb-5">
                  <div className="rounded-xl bg-white/[0.03] border border-white/5 p-4">
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <span className="inline-flex items-center gap-1 text-[10px] font-semibold text-emerald-300 bg-emerald-500/10 border border-emerald-500/20 rounded-full px-2 py-0.5">
                ...
                <div className="absolute -bottom-4 right-6 hidden md:flex items-center gap-2 rounded-xl border border-white/10 bg-[#0b111f]/90 backdrop-blur px-3.5 py-2.5 shadow-2xl shadow-black/50">
                  <Wallet className="w-4 h-4 text-emerald-400" strokeWidth={1.75} aria-hidden="true" />
                  <div>
