    ...
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <div className="flex items-center justify-between h-16 md:h-20">
          <Link href="/" className="flex items-center gap-3 shrink-0" aria-label="RentManager home">
            <BrandBadge size="lg" />
          </Link>
          ...
          <nav className="hidden lg:flex items-center gap-7 text-sm font-medium" aria-label="Primary">
            {NAV_LINKS.map((link) => (
              <Link
                key={link.href}
                href={link.href}
                className="text-white/70 hover:text-white transition-colors py-2 focus-visible:outline-none focus-visible:text-white rounded-md"
              >
                {link.label}
              </Link>
            ))}
          ...
          <div className="hidden md:flex items-center gap-2.5">
            <Link
              ...
              className="inline-flex items-center gap-1.5 text-sm font-medium text-white/70 hover:text-white transition-colors px-3 py-2 min-h-11 rounded-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400"
            >
            ...
            <Button href={SIGNUP_LANDLORD_HREF} variant="primary" size="sm" className="min-h-11">
              Get started
            </Button>
          </div>
          ...
          <button
            ...
            className="lg:hidden flex h-11 w-11 items-center justify-center rounded-xl text-white/70 hover:text-white hover:bg-white/5 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400"
          >
          ...
          <nav className="px-4 py-4 space-y-1 max-h-[calc(100vh-4rem)] overflow-y-auto" aria-label="Mobile">
            ...
            <div className="pt-3 space-y-2.5 border-t border-white/5 mt-3">
              <Link
                href={SIGNIN_LANDLORD_HREF}
                onClick={close}
                className="flex items-center justify-center gap-2 w-full px-4 py-3.5 rounded-xl text-sm font-medium text-white/80 border border-white/10 hover:text-white hover:border-white/25 transition-colors"
              >
